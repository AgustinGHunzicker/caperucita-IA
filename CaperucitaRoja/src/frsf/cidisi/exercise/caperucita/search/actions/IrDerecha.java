...
public class IrDerecha extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        System.out.println(Consola.textoColoreadoWhite("IrDerecha -> SearchBasedAgentState"));
        EstadoCaperucita estadoCaperucita = (EstadoCaperucita) s;
        Point posicionCaperucita = estadoCaperucita.getPosicionCaperucita();

        EstadoCelda celda = estadoCaperucita.getUltimaPerception().getDerechaPercepcion();

        int cantMovimientos = estadoCaperucita.getUltimaPerception().getCantMovimientosDerecha();
    ...
    public EnvironmentState execute(AgentState ast, EnvironmentState est) {
        System.out.println(Consola.textoColoreadoWhite("IrDerecha -> EnvironmentState"));
