...
public class IrIzquierda extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        System.out.println(Consola.textoColoreadoWhite("IrIzquierda -> SearchBasedAgentState"));
        EstadoCaperucita estadoCaperucita = (EstadoCaperucita) s;
        Point posicionCaperucita = estadoCaperucita.getPosicionCaperucita();

        EstadoCelda celda = estadoCaperucita.getUltimaPerception().getIzquierdaPercepcion();

        int cantMovimientos = estadoCaperucita.getUltimaPerception().getCantMovimientosIzquierda();
