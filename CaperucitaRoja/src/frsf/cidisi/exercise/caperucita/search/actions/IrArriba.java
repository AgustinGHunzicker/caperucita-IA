...
public class IrArriba extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        EstadoCelda celda = estadoCaperucita.getUltimaPerception().getArribaPercepcion();

        int cantMovimientos = estadoCaperucita.getUltimaPerception().getCantMovimientosArriba();
